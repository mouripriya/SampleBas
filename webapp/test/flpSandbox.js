		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tech_bol",
									"targetURL": "#comTechboltechbol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comTechboltechbol-display": {
								"semanticObject": "comTechboltechbol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.Techbol.techbol",
									"url": sap.ui.require.toUrl("com/Techbol/techbol")
								}
							}
						}
					}
